...
class _$_LikePostToken implements _LikePostToken {
  ...
  @override
  String toString() {
    return 'LikePostToken(activeUid: $activeUid, createdAt: $createdAt, passiveUid: $passiveUid, postRef: $postRef, postId: $postId, tokenId: $tokenId)';
  }
...
abstract class _LikePostToken implements LikePostToken {
  const factory _LikePostToken(
      ...
      required final String tokenId}) = _$_LikePostToken;
