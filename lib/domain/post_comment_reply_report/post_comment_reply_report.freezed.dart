...
// メインの報告内容
  ...
  @override
  String toString() {
    return 'PostCommentReplyReport(acitiveUid: $acitiveUid, createdAt: $createdAt, others: $others, reportContent: $reportContent, postCommentReplyCreatorUid: $postCommentReplyCreatorUid, passiveUserName: $passiveUserName, postCommentReplyDocRef: $postCommentReplyDocRef, postCommentReplyId: $postCommentReplyId, postCommentReplyReportId: $postCommentReplyReportId, reply: $reply, replyLanguageCode: $replyLanguageCode, replyNagativeScore: $replyNagativeScore, replyPositiveScore: $replyPositiveScore, replySentiment: $replySentiment)';
  }
