...
class _$_Post implements _Post {
  ...
  @override
  String toString() {
    return 'Post(createdAt: $createdAt, hashTags: $hashTags, imageURL: $imageURL, likeCount: $likeCount, text: $text, textLanguageCode: $textLanguageCode, textNagativeScore: $textNagativeScore, textPositiveScore: $textPositiveScore, textSentiment: $textSentiment, postCommentCount: $postCommentCount, postId: $postId, reportCount: $reportCount, muteCount: $muteCount, uid: $uid, userName: $userName, userNameLanguageCode: $userNameLanguageCode, userNameNagativeScore: $userNameNagativeScore, userNamePositiveScore: $userNamePositiveScore, userNameSentiment: $userNameSentiment, userImageURL: $userImageURL, updatedAt: $updatedAt)';
  }
