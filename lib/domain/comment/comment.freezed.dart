...
class _$CommentImpl implements _Comment {
  ...
  @override
  String toString() {
    return 'Comment(createdAt: $createdAt, comment: $comment, commentLanguageCode: $commentLanguageCode, commentNagativeScore: $commentNagativeScore, commentPositiveScore: $commentPositiveScore, commentSentiment: $commentSentiment, likeCount: $likeCount, postRef: $postRef, postCommentId: $postCommentId, postCommentReplyCount: $postCommentReplyCount, reportCount: $reportCount, muteCount: $muteCount, userName: $userName, userNameLanguageCode: $userNameLanguageCode, userNameNagativeScore: $userNameNagativeScore, userNamePositiveScore: $userNamePositiveScore, userNameSentiment: $userNameSentiment, uid: $uid, userImageURL: $userImageURL, updatedAt: $updatedAt)';
  }
