...
class _$_Comment with DiagnosticableTreeMixin implements _Comment {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Comment(createdAt: $createdAt, comment: $comment, likeCount: $likeCount, postCommentId: $postCommentId, postCommentReplyCount: $postCommentReplyCount, userName: $userName, uid: $uid, userImageURL: $userImageURL)';
  }
